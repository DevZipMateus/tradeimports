...
import { FileText, Plane, Ship, Phone } from "lucide-react";
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12 text-center">
            <h1 className="section-title">Termo de Uso</h1>
          </div>

          {/* Embarques e Serviços */}
          <Card className="p-8 bg-white mb-8">
            <div className="flex items-center mb-6">
              <FileText className="text-tradeblue mr-3" size={32} />
          ...
          {/* Consulte Nosso Agente */}
          <Card className="p-8 bg-tradeblue text-white">
            <div className="flex items-center mb-4">
              <Phone className="text-white mr-3" size={32} />
              <h2 className="text-2xl font-semibold">
                Consulte Nosso Agente de Importação
              </h2>
            </div>
            <p className="text-lg leading-relaxed">
              Entre em contato conosco para mais informações sobre nossos serviços de importação e logística.
            </p>
          </Card>
        </div>
      </div>
